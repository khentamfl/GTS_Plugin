...
namespace Gts {
	...
	void Runtime::PlayImpactEffect(Actor* actor, std::string_view tag, std::string_view node, const NiPoint3& direction, float length, bool applyRotation, bool useLocalRotation) {
