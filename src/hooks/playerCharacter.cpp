...
namespace Hooks
{
	...
	{
		if (a_obj3D) {
			log::info("Obj Name: {}, Location L: x {}, y {}, z {}, Location W: x{}, y {}, z {}", a_obj3D->GetUserData()->GetActorOwner()->GetFullName(),a_obj3D->local.x, a_obj3D->local.y, a_obj3D->local.z, a_obj3D->world.x,a_obj3D->world.y,a_obj3D->world.z);
		}
