...
namespace Hooks
{
	class Hook_BGSImpactManager
	{
		...
		private:
			...
			static BSEventNotifyControl ProcessEvent(BGSImpactManager* a_this, const BGSCollisionSoundEvent* a_event, BSTEventSource<BGSCollisionSoundEvent>* a_eventSource);
			static inline REL::Relocation<decltype(ProcessEvent)> _ProcessEvent;
	};
}
