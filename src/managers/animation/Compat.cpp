...
namespace {
	...
	void MCO_SecondDodge(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, 1.20, 1.4, 10, 0.20, FootEvent::Right, 1.0, DeathCause::Crushed);
		DoDamageEffect(&data.giant, 1.20, 1.4, 10, 0.20, FootEvent::Left, 1.0, DeathCause::Crushed);
	...
	void JumpDown(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, 0.9 * damage, 6.0, 20, 0.25, FootEvent::Left, 1.0, DeathCause::Crushed);
		DoDamageEffect(&data.giant, 0.9 * damage, 6.0, 20, 0.25, FootEvent::Right, 1.0, DeathCause::Crushed);
