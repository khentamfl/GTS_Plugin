...
namespace {
	...
	void GTS_StrongStomp_ImpactR(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, damage * (4.8 + data.animSpeed/2) * perk, (1.80 + data.animSpeed/4) * damage, 5, 0.035, FootEvent::Right);
	...
	void GTS_StrongStomp_ImpactL(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, damage * (4.8 + data.animSpeed/2) * perk, (1.80 + data.animSpeed/4) * damage, 5, 0.035, FootEvent::Left);
