...
namespace {
	...
	void GTS_StrongStomp_LR_Start(AnimationEventData& data) {
		...
		DrainStamina(&data.giant, "StaminaDrain_StrongStomp", "DestructionBasics", true, 1.50, 4.0);
	}
	...
	void GTS_StrongStomp_ImpactR(AnimationEventData& data) {
		...
		DrainStamina(&data.giant, "StaminaDrain_StrongStomp", "DestructionBasics", false, 1.50, 4.0);
