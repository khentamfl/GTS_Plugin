...
namespace {
	...
	void GTSvore_impactLS(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, 0.5, 1.0, 30, 0.25, FootEvent::Left, 1.0, DamageSource::Crushed);
	}
	...
	void GTSvore_impactRS(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, 1.6, 1.3, 30, 0.25, FootEvent::Right, 1.0, DamageSource::Crushed);
