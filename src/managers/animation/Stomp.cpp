...
namespace {
	...
	void GTSstompimpactR(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, (2.45 + data.animSpeed/4) * launch * perk, (1.45 + data.animSpeed/4) * launch, 10, 0.03, FootEvent::Right, 1.0);
	...
	void GTSstompimpactL(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, (2.45 + data.animSpeed/4) * launch * perk, (1.45 + data.animSpeed/4) * launch, 10, 0.03, FootEvent::Left, 1.0);
	...
	void GTSstomplandR(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, 1.65 * perk, 1.45, 25, 0.025, FootEvent::Right, 1.0);
		DoSizeEffect(&data.giant, dust + data.animSpeed/4, FootEvent::Right, RNode);
	...
	void GTSstomplandL(AnimationEventData& data) {
		...
		DoDamageEffect(&data.giant, 1.65 * perk, 1.45, 25, 0.025, FootEvent::Left, 1.0);
		DoSizeEffect(&data.giant, dust + data.animSpeed/4, FootEvent::Left, LNode);
