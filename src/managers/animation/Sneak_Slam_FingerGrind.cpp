...
namespace {
    ...
    void Finger_DoDamage(Actor* giant, bool Right, float Radius, float Damage, float CrushMult, float ShrinkMult) {
		...
		Finger_DamageAndShrink(giant, Radius, Damage, node, 50, 0.10, 2.5 * CrushMult, -0.012 * ShrinkMult, source);
	}
	...
	void GTS_Sneak_FingerGrind_Impact_R(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, true, Radius_Sneak_FingerGrind_Impact, Damage_Sneak_FingerGrind_Impact, 2.4, 2.0);
    ...
    void GTS_Sneak_FingerGrind_Impact_L(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, false, Radius_Sneak_FingerGrind_Impact, Damage_Sneak_FingerGrind_Impact, 2.4, 2.0);
	...
	void GTS_Sneak_FingerGrind_Rotation_R(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, true, Radius_Sneak_FingerGrind_DOT, Damage_Sneak_FingerGrind_DOT, 2.8, 1.2);
		Finger_ApplyVisuals(&data.giant, Rfinger, 2.6, 0.85);
	};   
    void GTS_Sneak_FingerGrind_Rotation_L(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, false, Radius_Sneak_FingerGrind_DOT, Damage_Sneak_FingerGrind_DOT, 2.8, 1.2);
		Finger_ApplyVisuals(&data.giant, Lfinger, 2.6, 0.85);
	};   

	void GTS_Sneak_FingerGrind_Finisher_R(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, true, Radius_Sneak_FingerGrind_Finisher, Damage_Sneak_FingerGrind_Finisher, 1.8, 4.0);
    ...
    void GTS_Sneak_FingerGrind_Finisher_L(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, false, Radius_Sneak_FingerGrind_Finisher, Damage_Sneak_FingerGrind_Finisher, 1.8, 4.0);
