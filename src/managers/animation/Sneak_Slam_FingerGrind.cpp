...
namespace {
	...
	void GTS_Sneak_FingerGrind_Impact_R(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, true, Radius_Sneak_FingerGrind_Impact, Damage_Sneak_FingerGrind_Impact, 2.8, 1.2, false);
    ...
    void GTS_Sneak_FingerGrind_Impact_L(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, false, Radius_Sneak_FingerGrind_Impact, Damage_Sneak_FingerGrind_Impact, 2.8, 1.2, false);
	...
	void GTS_Sneak_FingerGrind_Rotation_R(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, true, Radius_Sneak_FingerGrind_DOT, Damage_Sneak_FingerGrind_DOT, 3.2, 0.8, false);
		Finger_ApplyVisuals(&data.giant, Rfinger, 2.6, 0.85);
	};   
    void GTS_Sneak_FingerGrind_Rotation_L(AnimationEventData& data) {
		Finger_DoDamage(&data.giant, false, Radius_Sneak_FingerGrind_DOT, Damage_Sneak_FingerGrind_DOT, 3.2, 0.8, false);
