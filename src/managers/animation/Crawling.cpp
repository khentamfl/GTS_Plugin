...
namespace {
	...
	void GTS_Crawl_Swipe_On_R(AnimationEventData& data) {
		...
		DrainStamina(&data.giant, "StaminaDrain_CrawlSwipe", "DestructionBasics", true, 1.2, 2.0);
	}
	...
	void GTS_Crawl_Swipe_Off_R(AnimationEventData& data) {
		...
		DrainStamina(&data.giant, "StaminaDrain_CrawlSwipe", "DestructionBasics", false, 1.2, 2.0);
	}
	...
	void GTS_Crawl_Swipe_Power_On_R(AnimationEventData& data) {
		...
		DrainStamina(&data.giant, "StaminaDrain_CrawlSwipeStrong", "DestructionBasics", true, 1.2, 2.6);
	}
	...
	void GTS_Crawl_Swipe_Power_Off_R(AnimationEventData& data) {
		DisableHandCollisions(&data.giant);
		DrainStamina(&data.giant, "StaminaDrain_CrawlSwipeStrong", "DestructionBasics", false, 1.2, 2.6);
	}
