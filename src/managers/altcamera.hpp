...
namespace Gts {
	class CameraManager : public EventListener {
		...
		private:
			...
			NiPoint3 manualEdit;
			Spring smoothScale = Spring(1.0, 1500.0);
			Spring3 smoothOffset = Spring3(NiPoint3(0.0, 0.0, 0.0), 1500.0);
			Spring3 smoothPlayerOffset = Spring3(NiPoint3(0.0, 0.0, 0.0), 1500.0);
	};
}
