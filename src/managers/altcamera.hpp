...
namespace Gts {
	class CameraManager : public EventListener {
		...
		private:
			...
			Spring smoothScale = Spring(0.15, 0.40);
			Spring3 smoothOffset = Spring3(NiPoint3(0.15, 0.15, 0.15), 0.40);
			Spring3 smoothPlayerOffset = Spring3(NiPoint3(0.15, 0.15, 0.15), 0.40);
	};
}
