...
#else                                                          // ALL
		// GTSControlMap can be accessed up to kTotal, kAETotal, or kVRTotal based on runtime
#endif
...
#	endif
	...
	//static_assert(sizeof(GTSControlMap) == 0x148);  // VS seems to choke even though this should be right
#endif
}
